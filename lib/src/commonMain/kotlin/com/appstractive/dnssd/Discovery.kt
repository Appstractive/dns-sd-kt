...
sealed interface DiscoveryEvent {
    ...
    /**
     * Emitted when a service was first discovered. Host and addresses may be empty at that point.
     * Use resolve() to get associated ip addresses. They will be delivered via DiscoveryEvent.Resolved.
     */
